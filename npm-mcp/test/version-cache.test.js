...
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.3\n"), "0.7.3");
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.3\r\n"), "0.7.3");
assert.strictEqual(
...
for (const malformed of [
  ...
  "phantom-mcp 0.7.3-untrusted\nextra\n",
  "prefix phantom-mcp 0.7.3\n",
  "phantom 0.7.3\n",
...
try {
  ...
  assert.strictEqual(isCachedBinaryStale(paths.binaryPath, {
    execFileSyncImpl: () => Buffer.from("phantom-mcp 0.7.3\n"),
  }), false);
