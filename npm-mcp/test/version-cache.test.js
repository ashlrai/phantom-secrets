...
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.0\n"), "0.7.0");
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.0\r\n"), "0.7.0");
assert.strictEqual(
...
for (const malformed of [
  ...
  "phantom-mcp 0.7.0-untrusted\nextra\n",
  "prefix phantom-mcp 0.7.0\n",
  "phantom 0.7.0\n",
...
try {
  ...
  assert.strictEqual(isCachedBinaryStale(paths.binaryPath, {
    execFileSyncImpl: () => Buffer.from("phantom-mcp 0.7.0\n"),
  }), false);
