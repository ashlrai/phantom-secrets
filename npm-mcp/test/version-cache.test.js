...
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.7\n"), "0.7.7");
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.7\r\n"), "0.7.7");
assert.strictEqual(
...
for (const malformed of [
  ...
  "phantom-mcp 0.7.7-untrusted\nextra\n",
  "prefix phantom-mcp 0.7.7\n",
  "phantom 0.7.7\n",
...
try {
  ...
  assert.strictEqual(isCachedBinaryStale(paths.binaryPath, {
    execFileSyncImpl: () => Buffer.from("phantom-mcp 0.7.7\n"),
  }), false);
