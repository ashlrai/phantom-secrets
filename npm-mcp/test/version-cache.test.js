...
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.9\n"), "0.7.9");
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.9\r\n"), "0.7.9");
assert.strictEqual(
...
for (const malformed of [
  ...
  "phantom-mcp 0.7.9-untrusted\nextra\n",
  "prefix phantom-mcp 0.7.9\n",
  "phantom 0.7.9\n",
...
try {
  ...
  assert.strictEqual(isCachedBinaryStale(paths.binaryPath, {
    execFileSyncImpl: () => Buffer.from("phantom-mcp 0.7.9\n"),
  }), false);
