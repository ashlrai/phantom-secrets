...
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.8\n"), "0.7.8");
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.8\r\n"), "0.7.8");
assert.strictEqual(
...
for (const malformed of [
  ...
  "phantom-mcp 0.7.8-untrusted\nextra\n",
  "prefix phantom-mcp 0.7.8\n",
  "phantom 0.7.8\n",
...
try {
  ...
  assert.strictEqual(isCachedBinaryStale(paths.binaryPath, {
    execFileSyncImpl: () => Buffer.from("phantom-mcp 0.7.8\n"),
  }), false);
