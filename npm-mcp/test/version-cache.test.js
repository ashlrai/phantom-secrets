...
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.4\n"), "0.7.4");
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.4\r\n"), "0.7.4");
assert.strictEqual(
...
for (const malformed of [
  ...
  "phantom-mcp 0.7.4-untrusted\nextra\n",
  "prefix phantom-mcp 0.7.4\n",
  "phantom 0.7.4\n",
...
try {
  ...
  assert.strictEqual(isCachedBinaryStale(paths.binaryPath, {
    execFileSyncImpl: () => Buffer.from("phantom-mcp 0.7.4\n"),
  }), false);
