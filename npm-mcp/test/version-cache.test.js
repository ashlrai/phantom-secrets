...
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.6\n"), "0.7.6");
assert.strictEqual(parseBinaryVersion("phantom-mcp 0.7.6\r\n"), "0.7.6");
assert.strictEqual(
...
for (const malformed of [
  ...
  "phantom-mcp 0.7.6-untrusted\nextra\n",
  "prefix phantom-mcp 0.7.6\n",
  "phantom 0.7.6\n",
...
try {
  ...
  assert.strictEqual(isCachedBinaryStale(paths.binaryPath, {
    execFileSyncImpl: () => Buffer.from("phantom-mcp 0.7.6\n"),
  }), false);
