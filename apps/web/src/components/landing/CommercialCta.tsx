...
export function CommercialCta({
  ...
  return (
    <a
      href={href}
      onClick={() => posthog.capture("pricing_cta_clicked", { tier: offeringId })}
      className={
        ...
        (featured
          ? "bg-blue text-white hover:-translate-y-px hover:bg-blue-d hover:shadow-[0_4px_24px_rgba(59,130,246,0.32)]"
