...
> Phantom 0.7.4 hard-denies every live provider issuance, enrollment exchange,
...
in 0.7.4 should invite a live vendor issuance call.
...
rotate --batch          metadata/manual guidance only in 0.7.4
...
Until those gates are implemented and accepted, the correct 0.7.4 behavior is
